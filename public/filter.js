...
// else {
// var errorMessage = [];
//     errorMessage.push("No more than five favorites may be selected")
//     var unchecker = document.querySelectorAll(".carFavorite:checked")
//     //console.log(unchecker.length)
//     //evt.target.checked=false
//     errorTemplateInsertPoint.innerHTML = errorTemplateInstance({
//         error: errorMessage
//     })
// }